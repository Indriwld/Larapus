 ...
 <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    Data Book
                                    <a href="{{ route('book.create')}}" class="btn btn-primary float-rigth">Tambah</a>
                                </div>
                                <!-- /.panel-heading -->
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                       <form action="{{route('book.destroy',$data->id)}}" method="post">
                                                           @method('delete')
                                                           @csrf
                                                       <a href="{{ route('book.edit',$data->id)}}" class="btn btn-success float-rigth">Ubah</a>
                                                        <a href="{{ route('book.show',$data->id)}}" class="btn btn-warning float-rigth">Tampil</a>
